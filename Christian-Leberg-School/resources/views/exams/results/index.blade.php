    ...
    <x-slot name="header">
        <div class="flex items-center justify-between">
            ...
            <div class="flex items-center space-x-2">
                <a href="{{ route('exams.results.create', $exam) }}" class="inline-flex items-center px-4 py-2 bg-gray-800 hover:bg-gray-900 text-white font-semibold rounded-lg transition-colors">
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-3xl font-bold text-gray-900 mt-1">{{ $totalResults }}</p>
                        </div>
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-3xl font-bold text-gray-900 mt-1">{{ number_format($averageScore, 1) }}%</p>
                        </div>
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-3xl font-bold text-gray-900 mt-1">{{ $studentsWithResults }}</p>
                        </div>
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-3xl font-bold text-gray-900 mt-1">{{ $subjectsWithResults }}</p>
                        </div>
                        <div class="bg-gray-100 rounded-full p-3">
                            <svg class="w-8 h-8 text-gray-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                <div class="flex flex-col md:flex-row md:items-center md:justify-between space-y-4 md:space-y-0">
                    ...
                    <div class="flex items-center gap-2">
                        <form method="GET" action="{{ route('exams.results.export', $exam) }}" class="inline">
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
                ...
                @if($results->isEmpty())
                    <div class="p-12 text-center">
                        ...
                        <a href="{{ route('exams.results.create', $exam) }}" class="inline-flex items-center px-6 py-3 bg-gray-800 hover:bg-gray-900 text-white font-semibold rounded-lg transition-colors">
                            ...
                            <tbody class="bg-white divide-y divide-gray-100">
                                @foreach($results as $result)
                                    <tr class="hover:bg-gray-50 transition-colors">
                                        <td class="px-6 py-4">
                                            <input type="checkbox" name="result_ids" value="{{ $result->id }}" x-model="selectedResults" class="rounded border-gray-300 text-gray-800 focus:ring-gray-400">
                                        </td>
                                        <td class="px-6 py-4">
                                            <div class="flex items-center">
                                                ...
                                                <div class="ml-4">
                                                    <div class="text-sm font-semibold text-gray-900">{{ $result->student->user->name }}</div>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-center">
                                            <div x-data="{ editing: false, marks: {{ $result->marks }} }">
                                                <span x-show="!editing" @click="editing = true" class="text-lg font-bold cursor-pointer
                                                    @if($result->marks >= 80) text-green-600
                                                    @elseif($result->marks >= 70) text-blue-600
                                                    @elseif($result->marks >= 60) text-yellow-600
                                                    @elseif($result->marks >= 50) text-orange-600
                                                    @else text-red-600
                                                    @endif">
                                                    {{ $result->marks }}%
                                                </span>
                                                <form x-show="editing" @submit.prevent="$el.submit()" action="{{ route('exam-results.update', $result) }}" method="POST" class="inline-flex items-center gap-2">
                                                    @csrf
                                                    @method('PUT')
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                            <a href="{{ route('students.show', $result->student) }}" class="text-gray-600 hover:text-gray-900 font-medium">
                                                View Student
                                            </a>
                                        </td>
                                    </tr>
            ...
            <div class="flex items-center justify-center min-h-screen px-4 pt-4 pb-20 text-center sm:block sm:p-0">
                ...
                <div x-show="showBulkEdit"
                    ...
                    <div class="bg-white px-6 pt-6 pb-4">
                        ...
                        <form action="{{ route('exams.results.bulk_update', $exam) }}" method="POST">
                            @csrf
