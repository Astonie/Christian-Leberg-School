                            ...
                            @foreach($report as $row)
                                <tr>
                                    ...
                                    <td class="px-6 py-4 text-right">
                                        <a href="{{ route('exams.student.report_card', [$exam->id, $row['student']->id]) }}" class="inline-flex items-center px-3 py-1 bg-gray-800 hover:bg-gray-900 text-white text-sm font-medium rounded transition-colors">
