...
<?php $component->withAttributes([]); ?>
    ...
    <div class="text-center mb-8">
        ...
        <p class="text-slate-600">Log in to access the <?php echo e(setting('site_name', 'School')); ?> Portal</p>
    </div>
...
<?php endif; ?>
        ...
        <div class="flex items-center justify-between">
            ...
            <?php if(Route::has('password.request')): ?>
                <a class="text-sm text-blue-600 hover:text-blue-800 font-medium transition-colors" href="<?php echo e(route('password.request')); ?>">
                    Forgot password?
                </a>
            <?php endif; ?>
        </div>
        ...
        <?php if(Route::has('register')): ?>
            <div class="text-center pt-4 border-t border-slate-200">
                <p class="text-sm text-slate-600">
                    ...
                    <a href="<?php echo e(route('register')); ?>" class="text-blue-600 hover:text-blue-800 font-semibold transition-colors">
                        Register here
                    </a>
                </p>
            </div>
...
<?php endif; ?>
<?php /**PATH C:\Users\THINKPAD -T15\Christian-Leberg-School\resources\views/auth/login.blade.php ENDPATH**/ ?>