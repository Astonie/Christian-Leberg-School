    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 items-center">
            ...
            <div class="text-center lg:text-left space-y-6 md:space-y-8">
                <?php if(setting('hero_badge_text')): ?>
                ...
                <h1 class="text-4xl sm:text-5xl lg:text-6xl font-bold tracking-tight leading-tight md:leading-[1.1]">
                    ...
                    <span class="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 via-brand-600 to-cyan-600"><?php echo e(setting('site_name', 'Our School')); ?></span>
                </h1>
                <p class="text-lg md:text-xl text-slate-700 max-w-2xl mx-auto lg:mx-0 leading-relaxed font-medium">
                    <?php echo e(setting('site_tagline', 'Empowering the next generation with a world-class curriculum, state-of-the-art facilities, and a community dedicated to holistic growth.')); ?>

                </p>
                
                <div class="flex flex-col sm:flex-row gap-3 md:gap-4 justify-center lg:justify-start">
                    <a href="<?php echo e(route('website.page', 'about')); ?>" class="px-6 py-3 md:px-8 md:py-4 bg-gradient-to-r from-blue-600 to-brand-600 text-white rounded-xl text-base md:text-lg font-semibold hover:shadow-xl hover:shadow-blue-500/40 transition-all transform hover:-translate-y-1">
                        Learn More
                    </a>
                    <a href="<?php echo e(route('website.blog')); ?>" class="px-6 py-3 md:px-8 md:py-4 bg-white text-slate-900 border-2 border-slate-300 rounded-xl text-base md:text-lg font-semibold hover:bg-slate-50 hover:border-slate-400 transition-all shadow-lg">
                        Latest News
                    </a>
                </div>
            </div>
            ...
            <div class="relative h-[400px] md:h-[500px] lg:h-[600px] mt-8 lg:mt-0">
                ...
                <div class="relative z-10 grid grid-cols-2 gap-3 md:gap-4 h-full">
                    <div class="space-y-3 md:space-y-4">
                        <?php if(setting('hero_image_1')): ?>
                        <div class="relative rounded-2xl md:rounded-3xl overflow-hidden shadow-2xl h-48 md:h-56 lg:h-64 group">
                            <img src="<?php echo e(asset(setting('hero_image_1'))); ?>" alt="<?php echo e(setting('site_name', 'School')); ?>" class="w-full h-full object-cover transform group-hover:scale-110 transition-transform duration-700">
                            <div class="absolute inset-0 bg-gradient-to-t from-black/50 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                        </div>
                        <?php endif; ?>
                        <?php if(setting('hero_image_2')): ?>
                        <div class="relative rounded-2xl md:rounded-3xl overflow-hidden shadow-xl h-36 md:h-44 lg:h-48 group">
                            <img src="<?php echo e(asset(setting('hero_image_2'))); ?>" alt="Our Students" class="w-full h-full object-cover transform group-hover:scale-110 transition-transform duration-700">
                            <div class="absolute inset-0 bg-gradient-to-t from-black/50 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                        </div>
                        <?php endif; ?>
                    </div>
                    <div class="space-y-3 md:space-y-4 mt-8 md:mt-12 lg:mt-8">
                        <?php if(setting('hero_image_3')): ?>
                        <div class="relative rounded-2xl md:rounded-3xl overflow-hidden shadow-xl h-36 md:h-44 lg:h-48 group">
                            <img src="<?php echo e(asset(setting('hero_image_3'))); ?>" alt="Our Classrooms" class="w-full h-full object-cover transform group-hover:scale-110 transition-transform duration-700">
                            <div class="absolute inset-0 bg-gradient-to-t from-black/50 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                        </div>
                        <?php endif; ?>
                        <?php if(setting('hero_image_4')): ?>
                        <div class="relative rounded-2xl md:rounded-3xl overflow-hidden shadow-2xl h-48 md:h-56 lg:h-64 group">
                            <img src="<?php echo e(asset(setting('hero_image_4'))); ?>" alt="School View" class="w-full h-full object-cover transform group-hover:scale-110 transition-transform duration-700">
                            <div class="absolute inset-0 bg-gradient-to-t from-black/50 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                        </div>
                        <?php endif; ?>
                    </div>
...
<section class="py-12 md:py-16 lg:py-20 bg-white">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-12 md:mb-16">
            <h2 class="text-3xl md:text-4xl lg:text-5xl font-bold text-slate-900 mb-4"><?php echo e(setting('features_title', 'Why Choose Us')); ?></h2>
            <p class="text-lg md:text-xl text-slate-600 max-w-3xl mx-auto"><?php echo e(setting('features_subtitle', 'We provide a comprehensive education that prepares students for success in an ever-changing world')); ?></p>
        </div>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8">
            ...
            <?php $__currentLoopData = $features; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $feature): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <div class="group bg-gradient-to-br <?php echo e($colors['from']); ?> <?php echo e($colors['to']); ?> p-6 md:p-8 rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 border <?php echo e($colors['border']); ?>">
                    <div class="w-14 h-14 md:w-16 md:h-16 bg-gradient-to-br <?php echo e($colors['bg']); ?> rounded-2xl flex items-center justify-center mb-4 md:mb-6 group-hover:scale-110 transition-transform">
                    ...
                    <h3 class="text-xl md:text-2xl font-bold text-slate-900 mb-3"><?php echo e($title); ?></h3>
                    <p class="text-slate-600 leading-relaxed"><?php echo e($description); ?></p>
                </div>
...
<section class="py-12 md:py-16 bg-white">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-8 md:mb-12 gap-4">
            ...
            <a href="<?php echo e(route('website.blog')); ?>" class="inline-flex items-center gap-2 text-blue-600 hover:text-blue-800 font-bold text-base md:text-lg group">
                View All 
                ...
                <article class="bg-white rounded-2xl shadow-lg border border-slate-100 overflow-hidden hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 flex flex-col">
                    <?php if($post->featured_image): ?>
                        <div class="relative h-48 md:h-56 overflow-hidden">
                            <img src="<?php echo e(Storage::url($post->featured_image)); ?>" alt="<?php echo e($post->title); ?>" class="w-full h-full object-cover transform hover:scale-110 transition-transform duration-700">
                    ...
                    <div class="p-5 md:p-6 flex-1 flex flex-col">
                        ...
                        <h3 class="text-lg md:text-xl font-bold text-slate-900 mb-3 line-clamp-2"><?php echo e($post->title); ?></h3>
                        <p class="text-slate-700 mb-4 flex-1 line-clamp-3"><?php echo e(Str::limit($post->excerpt, 120)); ?></p>
                        <a href="<?php echo e(route('website.blog.show', $post->slug)); ?>" class="text-blue-600 hover:text-blue-800 font-bold inline-flex items-center gap-2 group mt-auto">
                            Read More 
...
<section class="py-12 md:py-16 bg-gradient-to-br from-slate-50 to-blue-50">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-8 md:mb-12 gap-4">
            ...
            <a href="<?php echo e(route('website.events')); ?>" class="inline-flex items-center gap-2 text-blue-600 hover:text-blue-800 font-bold text-base md:text-lg group">
                View All 
                <svg class="w-5 h-5 group-hover:translate-x-1 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 8l4 4m0 0l-4 4m4-4H3"></path></svg>
            </a>
        </div>
            ...
            <?php $__currentLoopData = $upcomingEvents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $event): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <article class="bg-white rounded-2xl shadow-lg border border-slate-100 p-5 md:p-6 hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 flex flex-col">
                    <div class="text-center mb-4 pb-4 border-b-2 border-brand-100">
                        <div class="text-4xl md:text-5xl font-bold text-blue-600"><?php echo e($event->start_date->format('d')); ?></div>
                        <div class="text-sm text-slate-700 font-semibold mt-1"><?php echo e($event->start_date->format('M Y')); ?></div>
                    </div>
                    <h3 class="text-base md:text-lg font-bold text-slate-900 mb-3 line-clamp-2 flex-1"><?php echo e($event->title); ?></h3>
                    <div class="space-y-2 mb-4">
                        <p class="text-sm text-slate-700 flex items-start">
                            ...
                            <span><?php echo e($event->start_date->format('h:i A')); ?></span>
                        </p>
                    ...
                    <a href="<?php echo e(route('website.events.show', $event->slug)); ?>" class="text-blue-600 hover:text-blue-800 font-bold text-sm inline-flex items-center gap-2 group mt-auto">
                        View Details 
                        <svg class="w-4 h-4 group-hover:translate-x-1 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 8l4 4m0 0l-4 4m4-4H3"></path></svg>
                    </a>
                </article>
...
<section class="py-12 md:py-16 lg:py-20 bg-gradient-to-r from-blue-600 via-brand-600 to-cyan-600 text-white relative overflow-hidden">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div class="text-center mb-8 md:mb-12">
            <h2 class="text-3xl md:text-4xl font-bold mb-3 md:mb-4"><?php echo e(setting('stats_title', 'Our Achievements')); ?></h2>
            <p class="text-base md:text-lg text-white/90 max-w-2xl mx-auto"><?php echo e(setting('stats_subtitle', 'Proud of our accomplishments and continued commitment to excellence')); ?></p>
        </div>
        <div class="grid grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8">
            ...
            <?php $__currentLoopData = $stats; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $stat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <div class="text-center p-4 md:p-6 bg-white/10 rounded-2xl backdrop-blur-sm border border-white/20 hover:bg-white/20 transition-all transform hover:scale-105">
                    <div class="text-4xl md:text-5xl lg:text-6xl font-bold mb-2"><?php echo e($value); ?></div>
                    <div class="text-base md:text-lg lg:text-xl font-semibold text-white/90"><?php echo e($label); ?></div>
                </div>
                <?php endif; ?>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </div>
...
<section class="py-12 md:py-16 lg:py-20 bg-white">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <div class="bg-gradient-to-br from-blue-50 to-cyan-50 rounded-3xl p-8 md:p-12 lg:p-16 border-2 border-blue-100 shadow-xl">
            <h2 class="text-3xl md:text-4xl lg:text-5xl font-bold text-slate-900 mb-4"><?php echo e(setting('cta_title', 'Ready to Join Us?')); ?></h2>
            <p class="text-lg md:text-xl text-slate-700 mb-8 md:mb-10 font-medium max-w-2xl mx-auto"><?php echo e(setting('cta_subtitle', 'Discover how our school can help your child excel and reach their full potential')); ?></p>
            <div class="flex flex-col sm:flex-row justify-center gap-4">
                ...
                ?>
                <?php if($button1Text): ?>
                <a href="<?php echo e($button1Link); ?>" class="px-8 py-4 bg-gradient-to-r from-blue-600 to-brand-600 text-white rounded-xl text-base md:text-lg font-semibold hover:shadow-xl hover:shadow-blue-500/40 transition-all transform hover:-translate-y-1">
                    <?php echo e($button1Text); ?>

                </a>
                <?php endif; ?>
                <?php if($button2Text): ?>
                <a href="<?php echo e($button2Link); ?>" class="px-8 py-4 bg-slate-800 text-white rounded-xl text-base md:text-lg font-semibold hover:bg-slate-900 transition-all shadow-lg transform hover:-translate-y-1">
...
<?php echo $__env->make('website.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\THINKPAD -T15\Christian-Leberg-School\resources\views/website/home.blade.php ENDPATH**/ ?>