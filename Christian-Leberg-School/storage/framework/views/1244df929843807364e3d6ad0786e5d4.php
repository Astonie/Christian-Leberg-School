    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    <form method="POST" action="<?php echo e(route('assessment-structures.store')); ?>" id="assessmentForm">
                        <?php echo csrf_field(); ?>
                        ...
                        <div class="mb-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div>
                                    ...
                                    <input type="number" name="version" id="version" value="<?php echo e(old('version', 1)); ?>" min="1"
                                        class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                                </div>
                                ...
                                <div>
                                    ...
                                    <select name="grading_system_id" id="grading_system_id" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                                        ...
                                        <?php $__currentLoopData = $gradingSystems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $system): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($system->id); ?>" <?php echo e(old('grading_system_id') == $system->id ? 'selected' : ''); ?>>
    ...
    <script>
        ...
        function calculateTotalWeight() {
            ...
            if (Math.abs(total - 100) > 0.01 && total > 0) {
                ...
                submitBtn.disabled = false; // Still allow submission, server will validate
            } else if (total === 100) {
        ...
        // Add initial component on page load
...
<?php endif; ?>
<?php /**PATH C:\Users\THINKPAD -T15\Christian-Leberg-School\resources\views/assessment-structures/create.blade.php ENDPATH**/ ?>