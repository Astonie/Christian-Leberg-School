...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> 
        <div class="flex justify-between items-center">
            ...
            <a href="<?php echo e(route('assessment-structures.create')); ?>" class="bg-blue-600 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">
                    ...
                    <div class="p-6">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                ...
                                <p class="text-3xl font-bold text-gray-900"><?php echo e($structures->total()); ?></p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="p-6">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                ...
                                <p class="text-3xl font-bold text-gray-900"><?php echo e($structures->unique('subject_id')->count()); ?></p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="p-6">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                ...
                                <p class="text-3xl font-bold text-gray-900"><?php echo e($structures->count() > 0 ? number_format($structures->sum(fn($s) => $s->components->count()) / $structures->count(), 1) : 0); ?></p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="p-6">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                ...
                                <p class="text-3xl font-bold text-gray-900"><?php echo e($structures->max('version') ?? 1); ?></p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="p-6">
                    <div class="space-y-4">
                            ...
                            <div class="flex items-start justify-between">
                                ...
                                <div class="flex-1">
                                    <div class="flex items-center mb-3">
                                        ...
                                        <div>
                                            <h3 class="text-lg font-semibold text-gray-900"><?php echo e($structure->name); ?></h3>
                                            <?php if($structure->description): ?>
                                                <p class="text-sm text-gray-500 mt-1"><?php echo e(Str::limit($structure->description, 80)); ?></p>
                                            <?php endif; ?>
                                        </div>
                                    </div>
                                    ...
                                    <div class="flex items-center space-x-4 text-sm text-gray-600 mb-4">
                                        <div class="flex items-center">
                                            ...
                                            <span><?php echo e($structure->subject?->name ?? 'All Subjects'); ?></span>
                                        </div>
                                        <div class="flex items-center">
                                            <svg class="h-4 w-4 mr-1.5 text-green-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"/>
                                            </svg>
                                            <span><?php echo e($structure->gradingSystem?->name ?? 'Default System'); ?></span>
                                        </div>
                                        <div class="flex items-center">
                                            ...
                                            <span>Version <?php echo e($structure->version); ?></span>
                                        </div>
                                    </div>

                                    <!-- Components with Progress Bars -->
                                    <div class="space-y-2">
                                        <div class="text-xs font-semibold text-gray-500 uppercase mb-2">Components (<?php echo e($structure->components->count()); ?>)</div>
                                        <?php $__currentLoopData = $structure->components->sortBy('order')->take(5); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $component): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="flex items-center space-x-3">
                                            <span class="inline-flex items-center justify-center px-2 py-1 text-xs font-bold leading-none text-white bg-blue-600 rounded w-16">
                                                <?php echo e($component->code); ?>

                                            </span>
                                            <div class="flex-1">
                                                <div class="flex items-center justify-between mb-1">
                                                    <span class="text-sm text-gray-700 font-medium"><?php echo e($component->name); ?></span>
                                                    <span class="text-sm font-bold text-blue-600"><?php echo e($component->weight); ?>%</span>
                                                </div>
                                        ...
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        <?php if($structure->components->count() > 5): ?>
                                        <div class="text-xs text-gray-500 italic ml-20">
                                            + <?php echo e($structure->components->count() - 5); ?> more components
                                        </div>
                                        <?php endif; ?>
                                    </div>
                                </div>
                                ...
                                <div class="ml-6 flex flex-col space-y-2">
                                    <a href="<?php echo e(route('assessment-structures.show', $structure)); ?>" 
                                    ...
                                    <a href="<?php echo e(route('assessment-structures.edit', $structure)); ?>" 
                                    ...
                                    <form action="<?php echo e(route('assessment-structures.destroy', $structure)); ?>" method="POST" class="inline" 
                        ...
                        <div class="text-center py-12">
                            ...
                            <div class="mt-6">
                                <a href="<?php echo e(route('assessment-structures.create')); ?>" 
...
<?php endif; ?>
<?php /**PATH C:\Users\THINKPAD -T15\Christian-Leberg-School\resources\views/assessment-structures/index.blade.php ENDPATH**/ ?>