<div class="fixed inset-y-0 left-0 z-50 flex flex-col w-64 bg-gradient-to-b from-slate-900 via-slate-900 to-slate-950 text-white min-h-screen transition-all duration-300 ease-in-out shadow-2xl transform lg:translate-x-0 lg:static lg:inset-0"
    ...
    <nav class="flex-1 px-2 sm:px-3 py-4 lg:py-6 space-y-1 overflow-y-auto scrollbar-thin scrollbar-thumb-slate-700 scrollbar-track-transparent">
        ...
        <!-- Dashboard -->
        <a href="<?php echo e(route('dashboard')); ?>" @click="if (window.innerWidth < 1024) sidebarOpen = false" class="group flex items-center px-3 py-2.5 rounded-xl transition-all duration-200 <?php echo e(request()->routeIs('dashboard*') ? 'bg-gradient-to-r from-blue-600 to-cyan-500 text-white shadow-lg shadow-blue-500/30' : 'text-slate-300 hover:bg-slate-800/50 hover:text-white'); ?>">
            <div class="flex items-center justify-center w-9 h-9 rounded-lg <?php echo e(request()->routeIs('dashboard*') ? 'bg-white/10' : 'bg-slate-800/50 group-hover:bg-slate-700/50'); ?> transition-all duration-200">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <?php if(auth()->user()->hasRole('admin')): ?>
            <!-- Users -->
            <a href="<?php echo e(route('users.index')); ?>" class="group flex items-center px-3 py-2.5 rounded-xl transition-all duration-200 <?php echo e(request()->routeIs('users*') ? 'bg-gradient-to-r from-blue-600 to-cyan-500 text-white shadow-lg shadow-blue-500/30' : 'text-slate-300 hover:bg-slate-800/50 hover:text-white'); ?>">
                <div class="flex items-center justify-center w-9 h-9 rounded-lg <?php echo e(request()->routeIs('users*') ? 'bg-white/10' : 'bg-slate-800/50 group-hover:bg-slate-700/50'); ?> transition-all duration-200">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <?php if(auth()->user()->hasRole('admin') || auth()->user()->hasRole('head-teacher') || auth()->user()->hasRole('deputy-head-teacher') || auth()->user()->hasRole('teacher')): ?>
            ...
            <?php if(auth()->user()->hasRole('admin') || auth()->user()->hasRole('head-teacher') || auth()->user()->hasRole('deputy-head-teacher') || auth()->user()->hasRole('head-teacher') || auth()->user()->hasRole('deputy-head-teacher')): ?>
                ...
                <!-- Guardians -->
                <a href="<?php echo e(route('guardians.index')); ?>" class="group flex items-center px-3 py-2.5 rounded-xl transition-all duration-200 <?php echo e(request()->routeIs('guardians*') ? 'bg-gradient-to-r from-blue-600 to-cyan-500 text-white shadow-lg shadow-blue-500/30' : 'text-slate-300 hover:bg-slate-800/50 hover:text-white'); ?>">
                    <div class="flex items-center justify-center w-9 h-9 rounded-lg <?php echo e(request()->routeIs('guardians*') ? 'bg-white/10' : 'bg-slate-800/50 group-hover:bg-slate-700/50'); ?> transition-all duration-200">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <?php else: ?>
                <!-- Teacher quick links -->
                <a href="<?php echo e(route('teacher.subjects')); ?>" class="group flex items-center px-3 py-2.5 rounded-xl transition-all duration-200 <?php echo e(request()->routeIs('teacher.subjects') ? 'bg-gradient-to-r from-blue-600 to-cyan-500 text-white shadow-lg shadow-blue-500/30' : 'text-slate-300 hover:bg-slate-800/50 hover:text-white'); ?>">
                    <div class="flex items-center justify-center w-9 h-9 rounded-lg <?php echo e(request()->routeIs('teacher.subjects') ? 'bg-white/10' : 'bg-slate-800/50 group-hover:bg-slate-700/50'); ?> transition-all duration-200">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="<?php echo e(route('teacher.streams')); ?>" class="group flex items-center px-3 py-2.5 rounded-xl transition-all duration-200 <?php echo e(request()->routeIs('teacher.streams') ? 'bg-gradient-to-r from-blue-600 to-cyan-500 text-white shadow-lg shadow-blue-500/30' : 'text-slate-300 hover:bg-slate-800/50 hover:text-white'); ?>">
                    <div class="flex items-center justify-center w-9 h-9 rounded-lg <?php echo e(request()->routeIs('teacher.streams') ? 'bg-white/10' : 'bg-slate-800/50 group-hover:bg-slate-700/50'); ?> transition-all duration-200">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <?php if(auth()->user()->hasRole('admin') || auth()->user()->hasRole('head-teacher') || auth()->user()->hasRole('deputy-head-teacher') || auth()->user()->hasRole('teacher')): ?>
                ...
                <a href="<?php echo e(route('attendance.reports')); ?>" class="group flex items-center px-3 py-2.5 rounded-xl transition-all duration-200 <?php echo e(request()->routeIs('attendance.reports') ? 'bg-gradient-to-r from-blue-600 to-cyan-500 text-white shadow-lg shadow-blue-500/30' : 'text-slate-300 hover:bg-slate-800/50 hover:text-white'); ?>">
                    <div class="flex items-center justify-center w-9 h-9 rounded-lg <?php echo e(request()->routeIs('attendance.reports') ? 'bg-white/10' : 'bg-slate-800/50 group-hover:bg-slate-700/50'); ?> transition-all duration-200">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <?php if(auth()->user()->hasRole('guardian')): ?>
                <a href="<?php echo e(route('attendance.guardian-report')); ?>" class="group flex items-center px-3 py-2.5 rounded-xl transition-all duration-200 <?php echo e(request()->routeIs('attendance.guardian-report') ? 'bg-gradient-to-r from-blue-600 to-cyan-500 text-white shadow-lg shadow-blue-500/30' : 'text-slate-300 hover:bg-slate-800/50 hover:text-white'); ?>">
                    <div class="flex items-center justify-center w-9 h-9 rounded-lg <?php echo e(request()->routeIs('attendance.guardian-report') ? 'bg-white/10' : 'bg-slate-800/50 group-hover:bg-slate-700/50'); ?> transition-all duration-200">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <?php if(auth()->user()->hasRole('admin') || auth()->user()->hasRole('head-teacher') || auth()->user()->hasRole('deputy-head-teacher')): ?>
            ...
            <div x-show="academicOpen" x-collapse class="space-y-1">
                <a href="<?php echo e(route('academic-years.index')); ?>" class="group flex items-center px-3 py-2 rounded-xl transition-all duration-200 <?php echo e(request()->routeIs('academic-years*') ? 'bg-slate-800/70 text-white border-l-2 border-blue-500' : 'text-slate-400 hover:bg-slate-800/30 hover:text-slate-300 hover:border-l-2 hover:border-slate-600'); ?>">
                    <div class="w-1.5 h-1.5 rounded-full <?php echo e(request()->routeIs('academic-years*') ? 'bg-blue-500' : 'bg-slate-600 group-hover:bg-slate-500'); ?> ml-5 mr-3 transition-colors duration-200"></div>
                ...
                <a href="<?php echo e(route('subjects.index')); ?>" class="group flex items-center px-3 py-2 rounded-xl transition-all duration-200 <?php echo e(request()->routeIs('subjects*') ? 'bg-slate-800/70 text-white border-l-2 border-blue-500' : 'text-slate-400 hover:bg-slate-800/30 hover:text-slate-300 hover:border-l-2 hover:border-slate-600'); ?>">
                    <div class="w-1.5 h-1.5 rounded-full <?php echo e(request()->routeIs('subjects*') ? 'bg-blue-500' : 'bg-slate-600 group-hover:bg-slate-500'); ?> ml-5 mr-3 transition-colors duration-200"></div>
                ...
                <a href="<?php echo e(route('exams.index')); ?>" class="group flex items-center px-3 py-2 rounded-xl transition-all duration-200 <?php echo e(request()->routeIs('exams*') ? 'bg-slate-800/70 text-white border-l-2 border-blue-500' : 'text-slate-400 hover:bg-slate-800/30 hover:text-slate-300 hover:border-l-2 hover:border-slate-600'); ?>">
                    <div class="w-1.5 h-1.5 rounded-full <?php echo e(request()->routeIs('exams*') ? 'bg-blue-500' : 'bg-slate-600 group-hover:bg-slate-500'); ?> ml-5 mr-3 transition-colors duration-200"></div>
            ...
            <div x-show="recordsOpen" x-collapse class="space-y-1">
                <a href="<?php echo e(route('admin.grading_systems.index')); ?>" class="group flex items-center px-3 py-2 rounded-xl transition-all duration-200 <?php echo e(request()->routeIs('admin.grading_systems*') ? 'bg-slate-800/70 text-white border-l-2 border-blue-500' : 'text-slate-400 hover:bg-slate-800/30 hover:text-slate-300 hover:border-l-2 hover:border-slate-600'); ?>">
                    <div class="w-1.5 h-1.5 rounded-full <?php echo e(request()->routeIs('admin.grading_systems*') ? 'bg-blue-500' : 'bg-slate-600 group-hover:bg-slate-500'); ?> ml-5 mr-3 transition-colors duration-200"></div>
                    <span class="font-medium text-sm">Grading Systems</span>
                </a>
                
                <a href="<?php echo e(route('admin.grading_scales.index')); ?>" class="group flex items-center px-3 py-2 rounded-xl transition-all duration-200 <?php echo e(request()->routeIs('admin.grading_scales*') ? 'bg-slate-800/70 text-white border-l-2 border-blue-500' : 'text-slate-400 hover:bg-slate-800/30 hover:text-slate-300 hover:border-l-2 hover:border-slate-600'); ?>">
                    <div class="w-1.5 h-1.5 rounded-full <?php echo e(request()->routeIs('admin.grading_scales*') ? 'bg-blue-500' : 'bg-slate-600 group-hover:bg-slate-500'); ?> ml-5 mr-3 transition-colors duration-200"></div>
                    <span class="font-medium text-sm">Grading Scales</span>
                </a>
                
                <a href="<?php echo e(route('admin.assessment_structures.index')); ?>" class="group flex items-center px-3 py-2 rounded-xl transition-all duration-200 <?php echo e(request()->routeIs('admin.assessment_structures*') ? 'bg-slate-800/70 text-white border-l-2 border-blue-500' : 'text-slate-400 hover:bg-slate-800/30 hover:text-slate-300 hover:border-l-2 hover:border-slate-600'); ?>">
                    <div class="w-1.5 h-1.5 rounded-full <?php echo e(request()->routeIs('admin.assessment_structures*') ? 'bg-blue-500' : 'bg-slate-600 group-hover:bg-slate-500'); ?> ml-5 mr-3 transition-colors duration-200"></div>
        ...
        <?php if(auth()->user()->hasRole('admin')): ?>
            ...
            <div class="pt-4">
                <a href="<?php echo e(route('admin.settings.school.edit')); ?>" class="group flex items-center px-3 py-2.5 rounded-xl transition-all duration-200 <?php echo e(request()->routeIs('admin.settings.school*') ? 'bg-gradient-to-r from-blue-600 to-cyan-500 text-white shadow-lg shadow-blue-500/30' : 'text-slate-300 hover:bg-slate-800/50 hover:text-white'); ?>">
                    <div class="flex items-center justify-center w-9 h-9 rounded-lg <?php echo e(request()->routeIs('admin.settings.school*') ? 'bg-white/10' : 'bg-slate-800/50 group-hover:bg-slate-700/50'); ?> transition-all duration-200">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <!-- Roles & Permissions -->
            <div class="pt-4">
                <a href="<?php echo e(route('admin.roles.index')); ?>" class="group flex items-center px-3 py-2.5 rounded-xl transition-all duration-200 <?php echo e(request()->routeIs('admin.roles*') || request()->routeIs('admin.permissions*') ? 'bg-gradient-to-r from-blue-600 to-cyan-500 text-white shadow-lg shadow-blue-500/30' : 'text-slate-300 hover:bg-slate-800/50 hover:text-white'); ?>">
                    <div class="flex items-center justify-center w-9 h-9 rounded-lg <?php echo e(request()->routeIs('admin.roles*') || request()->routeIs('admin.permissions*') ? 'bg-white/10' : 'bg-slate-800/50 group-hover:bg-slate-700/50'); ?> transition-all duration-200">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
<?php /**PATH C:\Users\THINKPAD -T15\Christian-Leberg-School\resources\views/layouts/sidebar.blade.php ENDPATH**/ ?>