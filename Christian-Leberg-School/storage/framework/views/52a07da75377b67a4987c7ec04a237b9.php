...
<?php $component->withAttributes([]); ?>
            ...
            <?php else: ?>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    <?php $__currentLoopData = $systems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $system): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="bg-white rounded-xl shadow-sm border border-gray-200 hover:shadow-lg transition-all duration-300 overflow-hidden <?php if($system->is_active): ?> ring-2 ring-green-500 <?php endif; ?>">
                            <!-- Card Header -->
                            <div class="bg-gradient-to-br from-indigo-50 to-blue-50 p-6 border-b border-gray-100">
                                <div class="flex items-start justify-between">
                                    <div class="flex-1">
                                        <div class="flex items-center gap-2 mb-2">
                                            <h3 class="text-xl font-bold text-gray-900"><?php echo e($system->name); ?></h3>
                                        ...
                                        <?php if($system->description): ?>
                                            <p class="text-sm text-gray-600"><?php echo e($system->description); ?></p>
                                        <?php endif; ?>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="p-6">
                                <h4 class="text-sm font-semibold text-gray-700 mb-3">Grading Scale (<?php echo e($system->scales->count()); ?> grades)</h4>
                                        ...
                                        <div class="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                                            <div class="flex items-center space-x-3">
                                                <div class="flex items-center justify-center w-10 h-10 bg-white rounded-lg shadow-sm">
                                                    <span class="font-bold text-sm text-gray-900"><?php echo e($scale->code); ?></span>
                                                </div>
                                                <div>
                                                    <p class="text-sm font-medium text-gray-900"><?php echo e($scale->label); ?></p>
                                                    <p class="text-xs text-gray-500"><?php echo e($scale->min_score); ?>% - <?php echo e($scale->max_score); ?>%</p>
                                                </div>
                                            </div>
                                            <?php if($scale->points): ?>
                                                <span class="text-sm font-semibold text-indigo-600"><?php echo e($scale->points); ?> pts</span>
                                            <?php endif; ?>
                                        </div>
                                ...
                                <div class="flex gap-2 pt-4 border-t border-gray-100">
                                    <?php if(!$system->is_active): ?>
                                        <form action="<?php echo e(route('admin.grading_systems.activate', $system)); ?>" method="POST" class="flex-1">
                                            <?php echo csrf_field(); ?>
                                    ...
                                    <?php endif; ?>
                                    <a href="<?php echo e(route('admin.grading_systems.show', $system)); ?>" class="flex-1 flex items-center justify-center px-3 py-2 bg-blue-50 hover:bg-blue-100 text-blue-700 font-medium rounded-lg transition-colors">
                                        <svg class="w-4 h-4 mr-1.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    ...
                                    <?php if(!$system->is_active): ?>
                                        <form action="<?php echo e(route('admin.grading_systems.destroy', $system)); ?>" method="POST" onsubmit="return confirm('Are you sure? This will delete all grades in this system.')">
                                            <?php echo csrf_field(); ?>
    ...
    <div id="createModal" class="hidden fixed inset-0 bg-gray-500 bg-opacity-75 flex items-center justify-center z-50">
        <div class="bg-white rounded-xl shadow-xl max-w-md w-full mx-4">
            <form method="POST" action="<?php echo e(route('admin.grading_systems.store')); ?>">
                <?php echo csrf_field(); ?>
                <div class="p-6">
...
<?php endif; ?>
<?php /**PATH C:\Users\THINKPAD -T15\Christian-Leberg-School\resources\views/admin/grading_systems/index.blade.php ENDPATH**/ ?>